...
The Animal Animation App was created by Didier Murillo and inspired by the Udemy course "Modern React with Redux" by Stephen Grider. Feel free to use, modify, and distribute the app as you like.
